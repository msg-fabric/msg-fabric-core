...
export default [
  { input: '../browser.hub.js', plugins: plugins_web, external,
    output: { file: `umd/browser.js`, format: 'umd', name: 'msg-fabric-core', sourcemap } },

  { input: 'websocket-WS.jsy', plugins: plugins_nodejs, external,
    output: { file: `cjs/websocket-WS.js`, format: 'cjs', sourcemap } },

  { input: 'websocket-FAYE.jsy', plugins: plugins_nodejs, external,
